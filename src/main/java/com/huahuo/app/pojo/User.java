...
public class User implements Serializable {
     ...
     * 特征五
     */
    @TableField(value = "fifth_character")
    private Integer fifthCharacter;
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getFifthCharacter() == null ? other.getFifthCharacter() == null : this.getFifthCharacter().equals(other.getFifthCharacter()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFifthCharacter() == null) ? 0 : getFifthCharacter().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", fifthCharacter=").append(fifthCharacter);
